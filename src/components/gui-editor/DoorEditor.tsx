  ...
  return (
    <div className="gui-section" data-testid="door-editor">
      <div className="section-header">
        <h3>🚪 Doors</h3>
        <button onClick={onAddDoor} className="add-button" data-testid="add-door-button">
          + Add Door
        </button>
      </div>
      {doors.map((door, index) => {
        ...
        return (
          <div
            ...
            data-testid={`door-card-${index}`}
          >
            <div className="card-header">
              <span className="item-label">
                {roomName} - Door {index + 1}
              </span>
              <button
                onClick={() => onDeleteDoor(index)}
                className="delete-button"
                data-testid={`delete-door-button-${index}`}
              >
                Delete
              </button>
            </div>
            ...
            <div className="form-grid">
              <label>
                ...
                <select
                  ...
                  onChange={e =>
                    onUpdateDoor(index, { ...door, swing: e.target.value as SwingDirection })
                  }
