...
function peg$parse(input, options) {
  ...
  function peg$f10(anchor, offset) {    return { anchor, offset };  }
  function peg$f11(offset) {    return { anchor: 'top-left', offset };  }
  function peg$f12(anchor) {    return { anchor, offset: null };  }
  function peg$f13(first, rest) {    return first + rest.join('');  }
  function peg$f14(chars) {    return chars.join('');  }
  function peg$f15(chars) {    return chars.join('');  }
  function peg$f16(width, depth) {    return { width, depth };  }
  function peg$f17(width, height) {    return { width, height };  }
  function peg$f18(width) {    return { width };  }
  function peg$f19() {    return 'top-left';  }
  function peg$f20() {    return 'top-right';  }
  function peg$f21() {    return 'bottom-left';  }
  function peg$f22() {    return 'bottom-right';  }
  function peg$f23(anchor) {
    return { target: 'zeropoint', anchor: anchor ? anchor[1] : 'top-left' };
  }
  function peg$f24(target, anchor) {
    return { target: target.toLowerCase(), anchor: anchor ? anchor[1] : 'bottom-right' };
  }
  function peg$f25(anchor) {
    return { target: 'room', anchor: anchor ? anchor[1] : 'bottom-right' };
  }
  function peg$f26(target, anchor) {
    return { target: target.toLowerCase(), anchor: anchor ? anchor[1] : 'bottom-right' };
  }
  function peg$f27(x, y) {    return [x, y];  }
  function peg$f28(offset) {    return [offset];  }
  function peg$f29() {    return 'top';  }
  function peg$f30() {    return 'bottom';  }
  function peg$f31() {    return 'left';  }
  function peg$f32() {    return 'right';  }
  function peg$f33() {    return 'inwards-left';  }
  function peg$f34() {    return 'inwards-right';  }
  function peg$f35() {    return 'outwards-left';  }
  function peg$f36() {    return 'outwards-right';  }
  function peg$f37() {    return 'opening';  }
  function peg$f38() {    return 'square';  }
  function peg$f39() {    return 'circle';  }
  function peg$f40(hex) {    return '#' + hex.join('');  }
  function peg$f41(sign, digits) {    return parseInt((sign || '') + digits.join(''), 10);  }
