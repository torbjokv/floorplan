...
When('I add doors to all four walls of {string}', async function(this: FloorplanWorld, roomName: string) {
  const currentJson = (this as any).currentJson;
  const roomId = currentJson.rooms[0].id;
...
Then('doors should appear on top, bottom, left, and right walls', async function(this: FloorplanWorld) {
  const svg = this.page.locator('.floorplan-svg');
  await expect(svg).toBeVisible();
...
When('I add windows to all four walls of {string}', async function(this: FloorplanWorld, roomName: string) {
  const currentJson = (this as any).currentJson;
  const roomId = currentJson.rooms[0].id;
...
Then('windows should appear on top, bottom, left, and right walls', async function(this: FloorplanWorld) {
  const svg = this.page.locator('.floorplan-svg');
  await expect(svg).toBeVisible();
...
When('I add {int} doors to {string}', async function(this: FloorplanWorld, count: number, roomWall: string) {
  const currentJson = (this as any).currentJson;
...
When('I add {int} windows to {string}', async function(this: FloorplanWorld, count: number, roomWall: string) {
  const currentJson = (this as any).currentJson;
...
Then('all {int} windows should be visible on the top wall', async function(this: FloorplanWorld, count: number) {
  const svg = this.page.locator('.floorplan-svg');
  await expect(svg).toBeVisible();
...
When('I add a door and a window to {string}', async function(this: FloorplanWorld, roomWall: string) {
  const currentJson = (this as any).currentJson;
...
Then('the door thickness should be {int}mm', async function(this: FloorplanWorld, thickness: number) {
  const svg = this.page.locator('.floorplan-svg');
  await expect(svg).toBeVisible();
...
Then('the window thickness should be {int}mm', async function(this: FloorplanWorld, thickness: number) {
  const svg = this.page.locator('.floorplan-svg');
  await expect(svg).toBeVisible();
...
Given('I have a composite room with {int} parts', async function(this: FloorplanWorld, partCount: number) {
  const json = {
    grid_step: 1000,
    rooms: [{
      id: 'composite1',
